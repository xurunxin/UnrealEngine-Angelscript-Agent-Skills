---
name: ueas-review
description: Review UnrealEngine-Angelscript and EmmsUI changes for correctness, reflection surface, hot reload, cooked builds, networking, UI identity, performance, and version compatibility.
---
