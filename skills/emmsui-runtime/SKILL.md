---
name: emmsui-runtime
description: Build runtime immediate-mode UMG interfaces with EmmsUI using UMMWidget, draw contexts, overlays, widget components, persistent state, attributes, slots, events, and stable identity.
---
